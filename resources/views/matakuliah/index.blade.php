                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="btn-group" role="group">
                            <a href="/matakuliah/{{ $matkul->id }}/edit" class="btn btn-warning btn-sm text-dark">Edit</a>
                            {{-- create small space between button --}}
                            &nbsp; | &nbsp;
                            <form action="/matakuliah/{{ $matkul->id }}" method="post">
                                @method('DELETE')
                                @csrf
                                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Yakin akan Menghapus Data ini ?{{ $matkul->matakuliah }}')">Delete</button>
                            </form>
                        </div>
                    </td>
                </tr>

...
<head>
    ...
    <title>Admin Room | @yield('title')</title>
    <link rel="canonical" href="https://www.wrappixel.com/templates/ample-admin-lite/" />
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ url('plugins/images/favicon (5).png') }}">
    <!-- Custom CSS -->
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="{{ url('/dashboard') }}">
                        ...
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
                            <img src="{{ url('plugins/images/favicon1.png') }}" alt="homepage" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <h4 style="color: rgb(118, 121, 124); margin-top:10px;">Admin Room's</h4>
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- footer -->
                <!-- ============================================================== -->
                <footer class="footer text-center"> 2022 © Simple Admin Room's by <a
                    href="https://github.com/NabilaIzatiN">Nabila Izati Nisa</a>
            </footer>
                <!-- ============================================================== -->
                <!-- End footer -->
                <!-- ============================================================== -->

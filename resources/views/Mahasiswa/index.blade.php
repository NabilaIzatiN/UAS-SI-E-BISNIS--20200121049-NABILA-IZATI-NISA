                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="btn-group" role="group">
                            <a href="/mahasiswa/{{ $mhs->id }}/edit" class="btn btn-warning btn-sm text-dark">Edit</a>
                            {{-- create small space between button --}}
                            &nbsp; | &nbsp;
                            <form action="/mahasiswa/{{ $mhs->id }}" method="post">
                                @method('DELETE')
                                @csrf
                                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Yakin Menghapus Data {{ $mhs->nama_mhs }}')">Delete</button>
                            </form>
                        </div>
                    </td>
                </tr>
